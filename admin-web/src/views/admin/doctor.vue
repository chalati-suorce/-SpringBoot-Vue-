  ...
  <div class="dashboard-container">
    ...
    <el-card slot class="content-card" shadow="never">
      <el-table :data="list" stripe style="width: 100%; min-height: 60vh" border>
        ...
        <el-table-column prop="type" label="医生科室" header-align="center" align="center" />
      ...
      <div slot>
        <el-form ref="addForm" :model="addForm" label-width="80px" class="addForm" label-position="left" size="small">
          ...
          <el-form-item label="密码:">
            <el-input v-model="addForm.pwd" placeholder="请输入密码" type="password"></el-input>
          </el-form-item>
          <el-form-item label="手机号:">
            <el-input v-model="addForm.tel" placeholder="请输入手机号"></el-input>
          </el-form-item>
          <el-form-item label="医生科室:">
            <el-select v-model="addForm.type" placeholder="" class="w100">
              <el-option v-for="(item,index) in types" :value="item" :lebel="item" :key="index"></el-option>
            </el-select>
          </el-form-item>
          <el-form-item label="简介:">
            <el-input v-model="addForm.content" placeholder="请输入简介" type="textarea" rows="5"></el-input>
          </el-form-item>
...
export default {
  ...
  methods: {
    ...
    async confirm() {
      ...
      await api.doctorsave(this.addForm).then((res) => {
        if (res.code == 200) {
          this.$message.success("操作成功!");
          this.showDialog = false;
        } else {
